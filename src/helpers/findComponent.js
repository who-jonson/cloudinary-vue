...
*/
export const isCldPlaceholder = (component) => component.type?.name === COMPONENTS.CldPlaceholder;

export const isCldPoster = (component) => component.type?.name === COMPONENTS.CldPoster;
