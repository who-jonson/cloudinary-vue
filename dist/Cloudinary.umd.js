...
/* harmony default export */ var CldImagevue_type_script_lang_js = ({
  ...
  methods: {
    ...
    renderImageOnly: function renderImageOnly(src) {
      ...
      return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)("img", {
        "attrs": this.$attrs,
        "src": src,
    ...
    renderComp: function renderComp(children) {
      ...
      }, [this.renderImageOnly(src, true), displayPlaceholder && (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)("img", {
        "src": placeholder,
        "attrs": this.$attrs,
...
/* harmony default export */ var CldPostervue_type_script_lang_js = ({
  ...
  render: function render() {
    ...
    if (hasExtraTransformations && !this.extraTransformations.length) {
      return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.h)('div', {}, this.$slots.default);
    }
